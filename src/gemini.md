 ...
 *   **`Webhook_workflow (X).json`**: Son los flujos de trabajo principales que reciben las peticiones del bot. Contienen la lógica de clasificación, consulta a asistentes de OpenAI y la orquestación de respuestas. Son el "cerebro" de las operaciones de IA.
