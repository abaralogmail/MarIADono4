...
## Architecture
- **Multi-bot system**: Multiple WhatsApp bots running on different ports (6001-6009)
- **Core framework**: @bot-whatsapp/bot with Baileys provider for WhatsApp integration
- **Database**: sqlite for message storage
- **AI Integration**: OpenAI, Ollama, LangChain for intelligent responses
- **Message processing**: Flow-based conversation handling via src/flows/
- **Services**: PostgreSQL, SQLite, n8n automation, bulk messaging
